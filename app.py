# app.py - Streamlit entry point or main module, gluing everything together
import streamlit as st
from datetime import datetime
from config import (
    STRUCTURED_EXT, UNSTRUCTURED_EXT, DATE_FILTER_DEFAULT,
    CTR_THRESHOLD_DEFAULT, EXPOSURE_THRESHOLD_DEFAULT,
    SAR_TXN_COUNT_THRESHOLD_DEFAULT, MIN_RETENTION_YEARS_DEFAULT
)
...
from ui import (
    configure_page, sidebar_settings,
    show_metrics, show_chart, show_table_and_download
)
...
def main():
    ...
    # Render sidebar & grab settings
    (
        uploaded_file, selected_rules, selected_regs,
        date_filter, ctr_threshold, exposure_threshold,
        sar_threshold, min_retention_years
    ) = sidebar_settings(
        RULE_META, STRUCTURED_EXT, UNSTRUCTURED_EXT,
        DATE_FILTER_DEFAULT,
        CTR_THRESHOLD_DEFAULT, EXPOSURE_THRESHOLD_DEFAULT,
        SAR_TXN_COUNT_THRESHOLD_DEFAULT, MIN_RETENTION_YEARS_DEFAULT
    )
